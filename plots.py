from csv_tools import read_from_csv, fields_select, rows_to_2dcoordinates, field_apply, get_mapping
...
if __name__ == '__main__':
    ...
    plot = n_plot_bar('model', 'adversarial type', 'mAP 50', n, x, y, columns=8, direction='horizontal')
